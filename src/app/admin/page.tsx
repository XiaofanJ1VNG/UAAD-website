  ...
  return (
    ...
    >
      ...
      <input
        ...
        placeholder="Organizers / co-organizers (e.g. UAAD x Creative Code Art)"
        className="rounded-lg border border-white/15 bg-white/5 px-3 py-2 text-sm outline-none focus:border-accent"
      />
      <input
        value={form.time}
      ...
      {open && (
        <>
          <p className="text-xs text-white/40">
            ...
            <code className="text-white/60">co-organizer</code> (who&apos;s behind the
            event — also accepts <code className="text-white/60">organizers</code> or{" "}
            <code className="text-white/60">Curator</code> as column names, they all map
            to the same field),{" "}
            ...
            <code className="text-white/60">Link</code> also works as a column name),{" "}
            ...
            the event or via the bulk image uploader below), and{" "}
            <code className="text-white/60">archived</code> (true/false, optional).
            Nothing is required — blank cells just import empty. Column names are
            matched case-insensitively, so &quot;Tags&quot;, &quot;tags&quot;, and
